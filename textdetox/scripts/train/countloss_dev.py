...
class CountLossTrainer(Trainer):
    def __init__(self, *args, lambda_count: float = 0.5, **kwargs):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        ...
        # This assumes a 'toxic_mask' is available in the dataset
        ...
        loss = ce_loss + self.lambda_count * count_loss
        return (loss, outputs) if return_outputs else loss

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="M1 Training with CE and COUNT Loss")
    ...
    print("Starting training with CE and COUNT Loss.")
    trainer.train()
    ...
    print("COUNT Loss model saved to:", final_dir)